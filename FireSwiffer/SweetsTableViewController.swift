...
class SweetsTableViewController: UITableViewController {
    ...
    @IBAction func loginAndSignUp(sender: AnyObject) {
        ...
        userAlert.addAction(UIAlertAction(title: "Sign in", style: .Default, handler: { (alert: UIAlertAction) in
        ...
        userAlert.addAction(UIAlertAction(title: "Sign up", style: .Default, handler: { (alert: UIAlertAction) in
            let emailTextField = userAlert.textFields!.first!
            let passwordTextField = userAlert.textFields!.last!
    ...
    @IBAction func addSweet(sender: AnyObject) {
        ...
        sweetAlert.addAction(UIAlertAction(title: "Send", style: .Default, handler: { (action: UIAlertAction) in
            if let sweetContent = sweetAlert.textFields?.first?.text {
                let sweet = Sweet(content: sweetContent, addedByUser: "BraianAdvent")
    ...
    override func viewDidLoad() {
        ...
        dbRef = FIRDatabase.database().reference().child("sweet-itmes")
        startObservingDB()
    }
